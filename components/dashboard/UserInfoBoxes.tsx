...
const UserInfoBoxes: React.FC<UserInfoBoxesProps> = ({
  ...
  return (
    <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-40">
      <div className="p-4 w-full md:w-[260px] min-h-[110px] bg-[rgba(255,255,255,0.06)] backdrop-blur-md border border-[#F68B61] rounded-[20px] flex flex-col justify-center gap-1">
