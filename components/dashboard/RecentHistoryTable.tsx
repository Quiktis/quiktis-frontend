        ...
        <div className="flex items-center gap-4">
          <div className="flex flex-col">
            ...
            <div
              ...
              className="flex items-center gap-1 bg-transparent px-3 py-1 rounded cursor-pointer"
            >
      ...
      <div className="max-h-[300px] overflow-y-auto pr-2 custom-scrollbar">
        <table className="w-full text-left">
          <thead className="border-b border-gray-700">
            <tr>
              <th className="py-2 px-4 text-sm font-bold uppercase text-gray-400">
                Event
              </th>
              <th className="py-2 px-4 text-sm font-bold uppercase text-gray-400">
                Date
          ...
          <tbody>
            {recentHistory.map((row) => (
              <tr key={row.id} className="border-b border-gray-700">
                <td className="py-2 px-4 text-sm text-white">{row.event}</td>
                <td className="py-2 px-4 text-sm text-white">{row.date}</td>
                <td className="py-2 px-4 text-sm text-white">{row.price}</td>
                <td className="py-2 px-4 text-sm text-white">{row.venue}</td>
                <td className="py-2 px-4 text-sm text-white">{row.ticketType}</td>
                <td className="py-2 px-4 text-sm text-white">{row.quality}</td>
                <td className="py-2 px-4 text-sm text-white">{row.totalSpent}</td>
              </tr>
            ))}
          </tbody>
        </table>
