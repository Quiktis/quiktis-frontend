...
interface BlogViewComponentProps {
    bannerImage: string;
    blogTitle: string;
    blogContent: string;
    dateAuthored: string;
...
const BlogViewComponent: React.FC<BlogViewComponentProps> = ({ bannerImage, blogTitle, blogContent, dateAuthored }) => {
    ...
    <div className="min-h-screen text-white">
      ...
      <section className="px-6">
        ...
        <article className="pb-8 space-y-4 text-gray-300">
          ...
          <p className="text-gray-400 mb-8">{dateAuthored}</p>
