  ...
  return (
    <section className={`relative py-10 overflow-hidden ${containerClass}`}>
      <div className="relative z-10 container mx-auto text-white">
            ...
            >
              ...
              <div className="flex justify-center gap-4 md:grid grid-cols-2 max-sm:flex-col sm:flex-col">
                <a
                  ...
                  className="lg:w-fit border border-gray-700 text-gray-400 hover:text-white rounded-[5px] text-xs md:text-sm md:py-3 md:px-6 py-2 px-4 flex justify-center"
                >
                  Read more{" "}
                  <FiArrowRight className="h-4 w-4 ml-1 mt-[0.2em]" />
                </a>

                <div>
                  <a
                    href={event.ticketLink}
                    className="bg-[#ff4d2a] lg:w-fit hover:bg-[#ff4d2a]/90 text-white font-semibold rounded-[5px] text-xs md:text-sm md:py-3 md:px-6 py-2 px-4 flex justify-center lg:mr-0 lg:ml-auto"
                  >
                    GET TICKET{" "}
        ...
        <div className="md:hidden flex gap-4 overflow-x-auto snap-x snap-mandatory scrollbar-hide max-md:py-4 max-md:h-[max-content]">
          {events.map((event) => (
            <div
              key={event.id}
