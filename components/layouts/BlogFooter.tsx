          ...
          <div className="w-full sm:w-1/2 md:w-1/3 flex flex-col text-center md:text-left">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-row items-center justify-center md:justify-start gap-4">
                <Link href="https://instagram.com/quiktis" target="_blank" rel="noopener" className="hover:text-[#FF4D2A] flex items-center gap-2">
                  <FontAwesomeIcon icon={faInstagram} size="lg" />
                </Link>
                <Link href="https://linkedin.com/company/quiktis" target="_blank" rel="noopener" className="hover:text-[#FF4D2A] flex items-center gap-2">
                  <FontAwesomeIcon icon={faLinkedin} size="lg" />
                </Link>
                <Link href="https://x.com/QuiktisTik" target="_blank" rel="noopener" className="hover:text-[#FF4D2A] flex items-center gap-2">
                  <FontAwesomeIcon icon={faTwitter} size="lg" />
                </Link>
                <Link href="https://discord.gg/TmavF8QCu5" target="_blank" rel="noopener" className="hover:text-[#FF4D2A] flex items-center gap-2">
                  <FontAwesomeIcon icon={faDiscord} size="lg" />
                </Link>
                <Link href="https://www.facebook.com/share/1BnfVxgh29/" target="_blank" rel="noopener" className="hover:text-[#FF4D2A] flex items-center gap-2">
