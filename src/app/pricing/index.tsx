...
export default function PricingPage() {
  return (
    <>
      ...
      <div className="bg-[#1C1E20] absolute inset-0 right-0 left-0" />
        ...
        <main className="px-2  py-16 z-[50] md:px-20 max-md:px-5 text-white">
          ...
          <div className="grid lg:grid-cols-3 gap-8 w-full mx-auto">
            ...
            <div className="bg-[#1C1E20] border border-[#2B2B2B] rounded-2xl p-8 z-50 flex flex-col">
              ...
              <Link
                href={"/register"}
                className="w-[100%] px-3 py-2 mb-8 bg-white text-black hover:bg-gray-100 rounded-md text-center font-semibold"
              >
                Get started
              </Link>
            ...
            <div className="bg-[#1C1E20] border border-[#2B2B2B] rounded-2xl p-8 z-50 flex flex-col">
              ...
              <Link
                href={"/register"}
                className="w-[100%] px-3 py-2 mb-8 bg-[#EA4335] hover:bg-red-600 rounded-md text-center font-semibold"
              >
                Get started
              </Link>
            ...
            <div className="bg-[#1C1E20] border border-[#2B2B2B] rounded-2xl p-8 z-50 flex flex-col">
              ...
              <Link
                href={"/register"}
                className="w-[100%] px-3 py-2 mb-8 bg-[#FB2E74] hover:bg-pink-600 rounded-md text-center font-semibold"
              >
                Get started
              </Link>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <span className="text-sm font-semibold">
                    Premium Analytics → ₦5,000 per event
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <Image
                  ...
                  />
                  <span className="text-sm font-semibold">
                    Custom Branding → ₦2,500 per event
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <Image
                  ...
                  />
                  <span className="text-sm font-semibold">
                    Priority Support → ₦1,500 per event
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <Image
