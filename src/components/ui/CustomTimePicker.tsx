...
import { TimeData } from "@/src/constant/customTypes";
...
const CustomTimePicker: React.FC<CustomTimePickerProps> = ({
  ...
  const handleSelect = (
    ...
    if (type === "hour") handleTimeDataChange(field, "hour", value.toString());
      ...
      handleTimeDataChange(field, "minute", value.toString());
  ...
  const selectedTime =
    ...
    timeData[field].period !== null
      ? `${String(timeData[field].hour).padStart(2, "0")}:${String(
          timeData[field].minute
        ).padStart(2, "0")} ${timeData[field].period}`
      : "";
            ...
            <div className="flex gap-3">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleSelect("hour", parseInt(e.target.value))
                  }
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleSelect("minute", parseInt(e.target.value))
                  }
                  className="w-24 p-2 border border-[#ffffff56] text-white rounded-md bg-[#1b1b1b] focus:outline-none focus:ring-2 focus:ring-blue-400"
                >
                  <option value="" disabled>
