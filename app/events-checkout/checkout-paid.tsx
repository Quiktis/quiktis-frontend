...
export default function CheckoutPaid() {
  ...
  return (
    <div className="bg-[#131517] min-h-screen text-gray-300 font-sans p-3 sm:p-4 md:p-6 lg:p-8">
      ...
      {showTicketPopup && (
        <div
          className="hide-scrollbar fixed inset-0 w-screen h-screen flex items-center justify-center p-3 sm:p-5 overflow-auto z-[9999] bg-[#131517F7]"
          onClick={() => setShowTicketPopup(false)}
        >
          <div
            className="hide-scrollbar bg-transparent w-full max-w-[1250px] flex flex-col items-start pt-12 sm:pt-16 md:pt-20 pb-6 sm:pb-10 max-h-[90vh] overflow-auto"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="mb-4 sm:mb-6 -mt-[40px] sm:-mt-[60px] md:-mt-[72px]">
              <button
                onClick={() => setShowTicketPopup(false)}
                className="w-[100px] sm:w-[124px] h-[38px] sm:h-[42px] bg-transparent border border-[#373737] rounded-[5px] flex-shrink-0 min-w-[100px] sm:min-w-[124px] whitespace-nowrap font-medium text-lg sm:text-xl leading-[100%] text-white cursor-pointer flex items-center justify-center gap-2 font-inter"
              >
                <svg
                  width="4.46"
                  height="8.11"
            ...
            <div className="w-full max-w-[600px] flex flex-col gap-6 sm:gap-8 md:gap-10 self-center px-3 sm:px-0">
              <div className="text-center">
                <h2
                  className="font-medium text-4xl leading-[96%] text-center text-white m-0 mb-3"
                  style={{ fontFamily: "Inter" }}
                >
                  Choose Ticket Type
                </h2>
                <p
                  className="font-medium text-[21.12px] leading-[121%] text-center text-[#919499] m-0"
                  style={{ fontFamily: "Inter" }}
                >
              ...
              {selectedTicket && (
                <button
                  ...
                  className="w-full bg-white border-none rounded-xl p-5 font-semibold text-lg text-[#131517] cursor-pointer mt-2"
