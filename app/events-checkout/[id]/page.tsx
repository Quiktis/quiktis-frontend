...
export default function CheckoutFree() {
 ...
 const origin =
    ...
    const shareUrl = `${origin}/events-checkout/${eventData?.event.id}`;
                  ...
                  <div className="flex gap-2.5">
                    ...
                    >
                      <div className="relative w-full h-full rounded-xl overflow-hidden">
                        ...
                        width={20}
                        height={25}
                        className="max-sm:w-[40vw] max-sm:h-[40vw] w-[17em] h-[17em] max-md:object-cover object-cover"
          ...
          <div className="lg:col-span-1 space-y-6 lg:sticky lg:top-6">
            {/* Poster image */}
              ...
              <SafeImage
                        ...
                        width={20}
                        height={25}
                        className="max-sm:w-[40vw] max-sm:h-[40vw] w-[24em] h-[24em] max-md:object-cover object-cover"
                        style={{ borderRadius: "16.75px" }}
                    />
