...
const RenderFilterRow: React.FC<renderFilterProps> = ({
  ...
  return (
    <div className="flex flex-wrap justify-center gap-4">
      {filters.map((filter) => (
        <Button
          key={filter} // Use filter value as the key instead of index
      ...
      <section className="relative z-40 mt-[2em] md:mt-[5em] text-center">
        ...
        <form className="mt-[3.5em] relative grid mx-auto place-items-center w-full md:w-[68%] lg:w-[50%] lg:max-w-[40em]">
          <input
            ...
            type="text"
            className="md:px-8 px-6 py-5 outline-none bg-[#79797965] w-full rounded-[1.6em]"
          ></input>
          <Link
            href="/register"
              ...
              <div key={index} className="flex flex-col gap-3 mb-7 w-full">
                <div className="grid grid-cols-[40px_auto] gap-3">
                  <Image
                    ...
                    height={40}
                  />
                  <h1 className="my-auto text-[1.1em] md:text-[1.2em] font-semibold">
                    {item.title}
                  </h1>
                </div>
