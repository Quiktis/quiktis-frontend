...
const ContactPage = () => {
  ...
  return (
    <main className="relative min-h-screen text-white mt-[4em] md:mt-[2.5em]">
      <Image
        src="/gradient.png"
      ...
      <div className="relative z-10 pt-4 pb-10 px-20 max-md:px-5">
        ...
        <section className="flex flex-col md:flex-row items-center justify-between gap-6 mt-4">
          <div className="flex-1">
            <h1 className="text-2xl md:text-3xl lg:text-5xl font-bold mb-2">Contact our team</h1>
        ...
        <section className="mt-10">
          <h2 className="text-left text-2xl md:text-3xl lg:text-4xl font-bold mb-6">Message Us</h2>
          <form
            ...
            <div className="flex flex-col justify-between">
              ...
              <div className="flex justify-end mt-4">
                <Button
                  type="submit"
                  className="flex max-md:w-full items-center bg-[#FF4D2A] py-3 px-6 text-white font-semibold rounded-md hover:bg-primary/90 transition-colors">
