...
export interface GetSupportedBankResponse extends Response {
  data: {
    id: number;
    name: string;
    slug: string;
...
export interface GetPayoutDetailsResponse extends Response {
  data: {
    id: string;
    createdAt: string;
...
export interface ConfirmPayoutDetailsResponse extends Response {
  data: {
    account_number: string;
    account_name: string;
    bank_id: number;
